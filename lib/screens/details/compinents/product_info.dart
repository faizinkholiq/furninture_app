...
class ProductInfo extends StatelessWidget {
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                buildContainer(defaultSize, color: Color(0xFF7BA275), isActive: true),
                buildContainer(defaultSize, color: Color(0xFFD7D7D7)),
                buildContainer(defaultSize, color: kTextColor),
              ],
            )
          ],
        ),
  ...
  Container buildContainer(double defaultSize, {required Color color, bool isActive = false}) {
    return Container(
